...
[LIVE LINK](https://jmoseka.github.io/Webpack-Setup/)
...
### Setup
1. Git [clone]("https://github.com/jmoseka/Webpsck-Setup") this repository to your local machine

> Issue the command ```git clone https://github.com/jmoseka/Webpsck-Setup``` on your terminal to download this repo

2. Download as [zip](https://github.com/jmoseka/Webpack-Setup.git) and extract the files to your local machine
